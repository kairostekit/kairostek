                ...
                <div class="col-lg-8">
                    <article class="post">
                        ...
                        <div class="post-content">
                            ...
                            <!-- blockquote -->
                            <blockquote data-aos="fade-left" data-aos-duration="1000">Excepteur sint occaecat cupidatat non
                                proi dent, sunt in culpa qui officia deserunt mollit anim iest.laborum.
...
<!-- blog details part end --></template>
